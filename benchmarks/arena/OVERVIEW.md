...
| # | Model | Score |
|---|-------|------:|
| 1 | `claude-opus-5-max` | 1692.000 |
| 2 | `kimi-k3-max` | 1674.000 |
| 3 | `qwen3.8-max` | 1667.000 |
| 4 | `claude-opus-5-high` | 1663.000 |
| 5 | `grok-4.6-high` | 1631.000 |
| 6 | `claude-fable-5` | 1627.000 |
| 7 | `gpt-5.6-sol-xhigh (codex-harness)` | 1622.000 |
| 8 | `gemini-3.7-flash-high` | 1587.000 |
| 9 | `glm-5.2-max` | 1585.000 |
| 10 | `deepseek-v4-pro-high-20260813` | 1584.000 |
...
| 3 | `muse-image` | 1405.000 |
| 4 | `mai-image-2.5` | 1402.000 |
| 5 | `seedream-5.0-pro` | 1393.000 |
| 6 | `chatgpt-image-latest-high-fidelity (20251216)` | 1390.000 |
| 7 | `grok-imagine-image-quality (20260519)` | 1390.000 |
| 8 | `gemini-3-pro-image-2k (nano-banana-pro)` | 1389.000 |
| 9 | `gemini-3-pro-image-preview (nano-banana-pro)` | 1385.000 |
| 10 | `reve-2.1` | 1374.000 |
